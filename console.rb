...
# name = Readline.readline("Please enter your name: ", true)
# age = Readline.readline("Please enter your age: ", true).to_i
# email = Readline.readline("Please enter your email address: ", true)

# # Here, we want to use the second last input (age)
# puts "Thank you, #{name.chomp}! You entered #{email.chomp} as your email address and you are #{age} years old."
